...
public class WebappStartupConfigurer implements ServletContextAware {
    ...
    public void setServletContext(ServletContext ctx) {
        ...
        loadAppInfo(ctx);
        loadServerInfo(ctx);
        loadGlobalVariables(ctx);
    }

    private void loadGlobalVariables(ServletContext ctx) {
	...
	private void loadAppInfo(ServletContext ctx) {
        ...
        appInfo.setProperty("buildVersion", appInfo.getProperty("buildVersion", "${project.groupId}-development.lastest"));
        ...
        appInfo.setProperty("fullBuildName",
                ...
                appInfo.getProperty("buildNumber") + ", build-date: " +

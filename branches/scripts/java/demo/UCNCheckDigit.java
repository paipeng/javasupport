...
public class UCNCheckDigit {

	public static void main(String[] args) {
		//Run test 100 times
		for(int i = 0; i < 100; i++){
			String ucn = generateUCN();
	...
	//Generate a random 9 alphanumberics UCN value
	private static String generateUCN(){
	...
	//Validate a given UCN with check digit is indeed valid.
